...
class SpeechTokenExtractor:
    ...
    def process_audio(self, audio_path: str) -> tuple:
        ...
        try:
            ...
            # Extract features using whisper (runs on GPU)
            ...
            # ONNX requires numpy input, so we need to move it back to CPU
    ...
    def extract_from_dataset(self, dataset_path: str, save_path: str):
        """Extract speech tokens from the dataset"""
